...
const Faq = () => {
    return (
        <div>
            <div className="">
                <h1 className="text-3xl sm:text-5xl text-[#061C3D] font-extrabold leading-[3.75rem] text-center  ">
                    FAQ
                </h1>
                <p className="text-center text-gray-600 text-base mt-2">Here are some of the frequently asked questions</p>
